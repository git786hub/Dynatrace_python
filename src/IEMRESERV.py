# AUTOSCRIPT NAME: IEMRESERV
# CREATEDDATE: 2014-11-10 14:43:55
# CREATEDBY: MAXADMIN
# CHANGEDATE: 2014-12-01 12:57:45
# CHANGEBY: MAXADMIN
...
# as a conditional launch point to reserve licenses.
...
if (iemswdMboSet.getMbo(0) == None):
    ...
    try:
        rc = LicReservHelper.reserveLicense(assetSet, licenseNum, orgId, tloamsoftwareId, mbo, 0)
        if (rc == 1):
            evalresult = True
