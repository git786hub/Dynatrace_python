# AUTOSCRIPT NAME: IEMLICCHKM
# CREATEDDATE: 2014-12-01 12:54:12
# CREATEDBY: MAXADMIN
# CHANGEDATE: 2014-12-05 12:50:55
# CHANGEBY: MAXADMIN
...
if (iemswdMboSet.getMbo(0) == None):
    ...
    try:
        rc = LicReservHelper.isLicenseAvailable(assetNum, siteId, licenseNumList, orgList, mbo.getUserInfo())  
        if (rc == 1):
            evalresult = True
        else:
            evalresult = False
