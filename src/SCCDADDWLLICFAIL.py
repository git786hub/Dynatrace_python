# AUTOSCRIPT NAME: SCCDADDWLLICFAIL
# CREATEDDATE: 2012-12-06 18:31:55
# CREATEDBY: MAXADMIN
# CHANGEDATE: 2012-12-07 13:57:12
# CHANGEBY: MAXADMIN
...
# indicating that the there are no sufficient licenses available. 
#----------------------------------------------------------------------------------------------------
...
if (originatingTicket != None):
    ...
    srWorklogMbo.setValue("description", getMsg("pmscoffering", "insufficient_license_sum"))
    srWorklogMbo.setValue("clientviewable", 1)
    srWorklogMbo.setValue("description_longdescription", getMsg("pmscoffering", "insufficient_license_desc"))
    print "In SCCDADDWLLICFAIL script: added an entry to SR worklog"