# AUTOSCRIPT NAME: SCCDADDWLLICSUCC
# CREATEDDATE: 2012-12-06 18:42:05
# CREATEDBY: MAXADMIN
...
# indicating that a license is reserved.  
#----------------------------------------------------------------------------------------------------
...
if (originatingTicket != None):
    ...
    print "In SCCDADDWLLICSUCC script: added an entry to SR worklog"